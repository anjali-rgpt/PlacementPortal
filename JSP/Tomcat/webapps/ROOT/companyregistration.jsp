        ...
        <body>
            <div id="navigationbar" class="sticky-top">
                ...
                <nav class="nav nav-pills nav-justified">
                    ...
                    <a href="http://localhost:8080/companyregistration.jsp" class="nav-item nav-link disabled"
                        id="register" name="register">Registration</a>
    ...
    stmt.executeQuery(query);
        ...
        %>
                <div class="row align-items-center justify-content-center">
                    <form id="register_form" method="POST" action="http://localhost:8080/mainpage.jsp"
                        ...
                        <fieldset name="company-details" class="border-light pl-2 m-3">
                            ...
                            <section id="company-role" class="row justify-content-between">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="companybox" id="companybox" value="Selected company"
                                        readonly required>
                                </div>
                                <div class="col-md-4">
